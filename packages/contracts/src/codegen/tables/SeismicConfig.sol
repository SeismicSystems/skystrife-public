...
library SeismicConfig {
   ...
   * @notice Get validator.
   */
  function get() internal view returns (address validator) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get validator.
   */
  function _get() internal view returns (address validator) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set validator.
   */
  function set(address validator) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set validator.
   */
  function _set(address validator) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function encodeStatic(address validator) internal pure returns (bytes memory) {
   ...
   */
  function encode(address validator) internal pure returns (bytes memory, EncodedLengths, bytes memory) {
    bytes memory _staticData = encodeStatic(validator);
